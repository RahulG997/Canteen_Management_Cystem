 ...
 */
  ...
  */
  ...
  private void payGst() {
    ...
    double gst = VendorFactory.showgstbyMonth(venId);
    GstDemo gstDemo = new GstDemo();
    gstDemo.setVenId(venId);
    gstDemo.setCgst(gst/2);
    gstDemo.setSgst(gst/2);
    gstDemo.setMonth(1);
    System.out.println(VendorFactory.payGst(gstDemo));
  ...
  private void showCustomerInfo() {
    ...
    System.out.println("----------------------------------------------------"
          + "----------------------------------------------");
    System.out.printf("%5s %15s %15s %20s %20s %20s", "Customer Id", "Customer Name",
        "Customer E-mail", "Customer Mobile", "Customer DOB", "Customer Address");
    System.out.println();
    System.out.println("----------------------------------------------------"
          + "----------------------------------------------");
