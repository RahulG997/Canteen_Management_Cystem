    ...
    switch (sfmchoice) {
      ...
      case 4:
        ...
        for (Orders fo : ord) {
          ...
          System.out.print(fo.getTotal() + "\t");
          System.out.print(fo.getQuantity() + "\t" + "\t");
          System.out.print(fo.getCusId() + "\t");
          System.out.print(fo.getOrdDate() + "\t");
          System.out.print(fo.getOrdStatus() + "\t");
          System.out.println(fo.getToken() + "\t");
        }
        break;
      case 5:
        Runtime.getRuntime().halt(0);
