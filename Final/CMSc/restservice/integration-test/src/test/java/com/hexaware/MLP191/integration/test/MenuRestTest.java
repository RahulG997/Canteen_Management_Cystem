package com.hexaware.MLP191.integration.test;
...
/**
 * @throws AssertionError ass
 * @throws URISyntaxException syn
 */
  @Test
...
/**
 * @throws AssertionError asser
 * @throws URISyntaxException syntax
 */
  @Test
  public void testFoodDetails() throws AssertionError, URISyntaxException {
    Menu m = given().accept(ContentType.JSON).
        when().get(CommonUtil.getURI("/api/menu/FoodDetails/101")).getBody().as(Menu.class);
