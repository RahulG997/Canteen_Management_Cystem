...
[
  ...
  {path : 'vendor-login', component : VendorLoginComponent,outlet:'data' },
  {path : 'customer-login', component : CustomerLoginComponent,outlet:'data' },
  {path : 'customersignup', component : CustomersignupComponent,outlet:'data' },
  {path : 'vendorsignup', component : VendorsignupComponent,outlet:'data' },
]
},
